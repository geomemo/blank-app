...
df = pd.read_csv("PopTra_cluster_corx4.csv", delimiter=';')
...
pages = ["00 Presentation", "01 Problem Statement", "02 Data Collection", "03 Data Overview", "04 Data Cleaning and Preparation", "05 Data Exploration",  "06 Model Selection", "07 Model Analysis", "08 Data Visualization", "09 Critical Appraisal", "10 Conclusion and Future Work"]
...
if page == pages[0]:    # Presentation of Project")
    ...
    st.image(image, caption='Population (Area Types) and Traffic (Vehicle Density Level) Map in PowerBI', use_column_width=True)
...
if page == pages[4]:    # Cleaning and Preparation
    ...
    st.image(image, caption='Flowchart 1', use_column_width=True)
...
if page == pages[9]:   # Critical Appraisal"
